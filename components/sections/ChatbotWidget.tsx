...
export function ChatbotWidget() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-5 right-5 z-[60]">
      {isOpen ? (
        <div className="pointer-events-auto mb-4 w-[calc(100vw-2.5rem)] max-w-sm overflow-hidden rounded-[2rem] border border-black/10 bg-white/95 shadow-[0_30px_100px_rgba(0,0,0,0.18)] backdrop-blur-2xl transition-all duration-300 dark:border-white/10 dark:bg-neutral-950/95">
      ...
      <button
        ...
        className="pointer-events-auto ml-auto flex h-14 w-14 items-center justify-center rounded-full bg-black text-white shadow-[0_20px_60px_rgba(0,0,0,0.25)] transition hover:scale-105 dark:bg-white dark:text-black"
      >
        {isOpen ? (
          <X className="h-6 w-6" />
        ) : (
