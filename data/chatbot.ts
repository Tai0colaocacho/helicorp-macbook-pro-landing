...
export const chatbotAnswers: Record<string, string> = {
  ...
  "Sinh viên nên chọn cấu hình nào?":
    "Nếu bạn là sinh viên IT hoặc thiết kế, cấu hình MacBook Pro M5 với 16GB RAM và 512GB SSD là lựa chọn cân bằng. Nếu làm video, AI, Docker hoặc project lớn, nên cân nhắc 24GB RAM hoặc 1TB SSD.",

  "Nên chọn RAM bao nhiêu?":
    "16GB phù hợp cho học tập, lập trình web và multitasking cơ bản. 24GB phù hợp hơn nếu bạn mở nhiều app, chạy Docker, dùng Figma hoặc làm project lớn. 32GB dành cho workflow nặng như video, 3D hoặc AI local.",
...
export const fallbackAnswer =
  "Mình có thể tư vấn về cấu hình, mục đích sử dụng, RAM, storage, pin, màn hình và sự khác biệt giữa MacBook Pro và MacBook Air. Hãy chọn một câu hỏi gợi ý bên dưới hoặc hỏi theo nhu cầu sử dụng của bạn.";